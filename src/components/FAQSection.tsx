    ...
    >
      <div className="max-w-5xl mx-auto">
        <div className="max-w-3xl mb-12 space-y-4">
          <span className="text-xs text-violet-400 tracking-widest">FAQ · AGENT AUTOMATION</span>
          <h2
            id="faq-heading"
            className="text-white font-black"
            style={{ fontSize: "clamp(2.25rem, 4.5vw, 3.75rem)", letterSpacing: "-0.04em", lineHeight: 0.98 }}
          >
            Sprintable과 Sellerking,
            <br />그리고 Agent 자동화에 대한 질문
          </h2>
          <p className="text-zinc-400 text-base leading-relaxed">
            아래 답변은 뭉클랩의 핵심 제품과 엔터프라이즈 Agent 자동화 접근 방식을 빠르게 이해할 수 있도록 정리한 요약입니다.
          </p>
        ...
        <div className="space-y-4">
          {faqItems.map((item) => (
            <details key={item.question} className="group border border-white/10 bg-white/[0.02] open:bg-white/[0.04]">
